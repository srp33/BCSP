...
public class TcgaMiRnaLevel3DataProcessor extends AbstractTcgaDataProcessor
{
    ...
    {
        for (File file : Files.GetFilesInDirectoryRecursively(GetRawDataDir(), INPUT_FILE_PATTERN))
        {
    ...
    {
        return Utilities.FormatNames(Lists.CreateStringList("hsa-miR-196a", "hsa-miR-196b"));
        // Guan2010
    }
}